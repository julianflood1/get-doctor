...
var displayDoctors = function(allDoctors) {
  ...
  $('.showDoctors').append('<div class ="panel"><h2>' + allDoctors[i].first_name + " " + allDoctors[i].last_name + '</h2><img id="doctor-img" src =' + allDoctors[i].image_url + '><p>' + 'Specialty: ' + allDoctors[i].name + '</p><textarea>' + allDoctors[i].bio + '</textarea></div>')
  }
};
